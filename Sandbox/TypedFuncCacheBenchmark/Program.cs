...
{
    private readonly ObjectFuncCacheResolver objectFuncCacheResolver = new();

    private readonly TypedFuncCacheResolver typedFuncCacheResolver = new();
...
{
    private readonly ThreadsafeTypeHashArrayMap<Func<object>> cache = new();
