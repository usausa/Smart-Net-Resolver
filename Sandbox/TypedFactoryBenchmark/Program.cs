...
{
    private readonly FuncResolver transientFuncResolver = new();

    private readonly TypedFuncResolver transientTypedFucResolver = new();
...
{
    private readonly ThreadsafeTypeHashArrayMap<Func<object>> factories = new();
