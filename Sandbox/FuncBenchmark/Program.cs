...
public class Benchmark
{
    ...
    public void Setup()
    {
        ...
        var nonSealedResolver0 = new NonSealedResolver0();
        var nonSealedResolver1 = new NonSealedResolver1(nonSealedResolver.Resolve);
        var nonSealedResolver2 = new NonSealedResolver2(nonSealedResolver.Resolve, nonSealedResolver.Resolve);
        nonSealed0Func = nonSealedResolver0.Resolve;
        nonSealed1Func = nonSealedResolver1.Resolve;
        nonSealed2Func = nonSealedResolver2.Resolve;
        ...
        direct0Func1 = _ => new Data0();
        direct1Func1 = _ => new Data1(directResolver);
        direct2Func1 = _ => new Data2(directResolver, directResolver);
    }
